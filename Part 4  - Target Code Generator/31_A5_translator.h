...
#ifndef __31_A5_TRANSLATOR_H__
#define __31_A5_TRANSLATOR_H__
...
public:
    ...
    void constructorInit(int val);
    void constructorInit(char val);
    void constructorInit(float val);
};
...
public:
    ...
    symbol* createSymbol(string name, DataType t, int pc);
